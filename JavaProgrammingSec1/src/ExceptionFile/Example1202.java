...
public class Example1202 {
    ...
    static Scanner input = new Scanner(System.in); //define object for input data from console
	...
	public static void showListStudent(int sec) throws IOException{
		...
		while ((temp = read.readLine()) != null) {
			...
			if(Integer.parseInt(data[3])==sec) {
				System.out.println(data[0] +" "+ data[2] +"\t"+ midtermScore +"\t"+ finalScore +"\t"+ totalScaore);
			}
		}

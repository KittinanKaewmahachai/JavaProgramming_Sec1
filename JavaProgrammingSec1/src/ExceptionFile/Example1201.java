...
public class Example1201 {
	...
	public static void main(String[] args) throws IOException{
		...
		while(read.hasNext()) {
			String fname = read.next(); //read data 1 from file to fname
			//String lname = read.next(); // read data from file to lname
			read.next(); //read data2 from file
			read.next(); //read data3 from file //ไม่ได้ใช้ id ใช้ read.next()
